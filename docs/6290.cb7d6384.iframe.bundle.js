  ...
  [6290],
  {
    "./node_modules/@storybook/blocks/dist/Color-PRSJMWNM.mjs": (
      ...
      var R,
        ...
        PickerTooltip = (0, dist.I4)(components_dist.WithTooltip)({
          position: "absolute",
          zIndex: 1,
          top: 4,
          left: 4,
        ...
        Note = (0, dist.I4)(components_dist.TooltipNote)(({ theme }) => ({
        ...
        Input = (0, dist.I4)(components_dist.Form.Input)(
          ({ theme, readOnly }) => ({
            width: "100%",
            paddingLeft: 30,
            paddingRight: 30,
        ...
        ToggleIcon = (0, dist.I4)(icons_dist.MarkupIcon)(({ theme }) => ({
          position: "absolute",
          zIndex: 1,
          top: 6,
          right: 7,

  ...
  [6949],
  {
    ...
    "./node_modules/@angular/cdk/fesm2022/a11y.mjs": (
      ...
      __webpack_require__.d(__webpack_exports__, {
        Pd: () => A11yModule,
        Au: () => ActiveDescendantKeyManager,
        vr: () => AriaDescriber,
        vR: () => CdkMonitorFocus,
        Bu: () => FocusKeyManager,
        FN: () => FocusMonitor,
        GX: () => FocusTrapFactory,
        Q_: () => HighContrastModeDetector,
        Z7: () => InteractivityChecker,
        Ai: () => LiveAnnouncer,
        px: () => addAriaReferencedId,
        _G: () => isFakeMousedownFromScreenReader,
        w6: () => isFakeTouchstartFromScreenReader,
        Ae: () => removeAriaReferencedId,
      });
      var common = __webpack_require__(
        ...
        fesm2022_platform = __webpack_require__(
      ...
      class MediaMatcher {
              ...
              (function createEmptyStyleRule(query, nonce) {
                ...
                try {
                  mediaQueryStyleNode ||
                    ...
                    nonce && mediaQueryStyleNode.setAttribute("nonce", nonce),
        ...
        static #_ = (this.ɵfac = function MediaMatcher_Factory(t) {
          return new (t || MediaMatcher)(
            core["ɵɵinject"](fesm2022_platform.OD),
            core["ɵɵinject"](core.CSP_NONCE, 8),
          );
        });
      ...
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          ...
          () => [
            { type: fesm2022_platform.OD },
            {
              type: void 0,
              decorators: [
                { type: core.Optional },
                { type: core.Inject, args: [core.CSP_NONCE] },
              ],
            },
          ],
          null,
      ...
      class BreakpointObserver {
        constructor(_mediaMatcher, _zone) {
          (this._mediaMatcher = _mediaMatcher),
            ...
            (this._destroySubject = new Subject.B());
        }
        ngOnDestroy() {
          this._destroySubject.next(), this._destroySubject.complete();
        }
        isMatched(value) {
          return splitQueries((0, coercion.FG)(value)).some(
            (mediaQuery) => this._registerQuery(mediaQuery).mql.matches,
          );
        }
        observe(value) {
          const observables = splitQueries((0, coercion.FG)(value)).map(
            (query) => this._registerQuery(query).observable,
          );
          let stateObservable = (0, combineLatest.z)(observables);
          return (
            (stateObservable = (0, concat.x)(
              stateObservable.pipe((0, take.s)(1)),
              stateObservable.pipe((0, skip.i)(1), (0, debounceTime.B)(0)),
            )),
            stateObservable.pipe(
              (0, map.T)((breakpointStates) => {
                const response = { matches: !1, breakpoints: {} };
                return (
          ...
          const mql = this._mediaMatcher.matchMedia(query),
            output = {
              observable: new Observable.c((observer) => {
                ...
                (0, startWith.Z)(mql),
                (0, map.T)(({ matches }) => ({ query, matches })),
                (0, takeUntil.Q)(this._destroySubject),
              ),
              mql,
            };
        ...
        static #_ = (this.ɵfac = function BreakpointObserver_Factory(t) {
          return new (t || BreakpointObserver)(
            core["ɵɵinject"](MediaMatcher),
      ...
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          BreakpointObserver,
          [{ type: core.Injectable, args: [{ providedIn: "root" }] }],
          () => [{ type: MediaMatcher }, { type: core.NgZone }],
          null,
        );
      const ID_DELIMITER = " ";
      function addAriaReferencedId(el, attr, id) {
        ...
        (id = id.trim()),
          ids.some((existingId) => existingId.trim() === id) ||
            (ids.push(id), el.setAttribute(attr, ids.join(ID_DELIMITER)));
      }
      ...
      class AriaDescriber {
        constructor(_document, _platform) {
          (this._platform = _platform),
            ...
            (this._id = (0, core.inject)(core.APP_ID) + "-" + nextId++);
        }
        describe(hostElement, message, role) {
          ...
          "string" != typeof message
            ...
            : this._messageRegistry.has(key) ||
              this._createMessageElement(message, role),
            this._isElementDescribedByMessage(hostElement, key) ||
        ...
        removeDescription(hostElement, message, role) {
          ...
          if (
            ...
            registeredMessage &&
              0 === registeredMessage.referenceCount &&
        ...
        ngOnDestroy() {
          const describedElements = this._document.querySelectorAll(
            `[cdk-describedby-host="${this._id}"]`,
          );
          for (let i = 0; i < describedElements.length; i++)
            this._removeCdkDescribedByReferenceIds(describedElements[i]),
              describedElements[i].removeAttribute("cdk-describedby-host");
          this._messagesContainer?.remove(),
            (this._messagesContainer = null),
        ...
        _createMessageElement(message, role) {
          ...
          setMessageId(messageElement, this._id),
            ...
            role && messageElement.setAttribute("role", role),
        ...
        _createMessagesContainer() {
          ...
          const serverContainers = this._document.querySelectorAll(
            '.cdk-describedby-message-container[platform="server"]',
          );
        ...
        _removeCdkDescribedByReferenceIds(element) {
          const originalReferenceIds = getAriaReferenceIds(
            element,
            "aria-describedby",
          ).filter((id) => 0 != id.indexOf("cdk-describedby-message"));
          element.setAttribute(
            "aria-describedby",
            originalReferenceIds.join(" "),
          );
        }
        _addMessageReference(element, key) {
          ...
          addAriaReferencedId(
            ...
            element.setAttribute("cdk-describedby-host", this._id),
        ...
        _removeMessageReference(element, key) {
          ...
          registeredMessage.referenceCount--,
            ...
            element.removeAttribute("cdk-describedby-host");
        }
        _isElementDescribedByMessage(element, key) {
          const referenceIds = getAriaReferenceIds(element, "aria-describedby"),
            registeredMessage = this._messageRegistry.get(key),
            messageId =
              registeredMessage && registeredMessage.messageElement.id;
          return !!messageId && -1 != referenceIds.indexOf(messageId);
        }
        _canBeDescribed(element, message) {
          if (!this._isElementNode(element)) return !1;
          if (message && "object" == typeof message) return !0;
          const trimmedMessage = null == message ? "" : `${message}`.trim(),
      ...
      function setMessageId(element, serviceId) {
        element.id ||
          (element.id = `cdk-describedby-message-${serviceId}-${nextId++}`);
      }
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          AriaDescriber,
      ...
      class ListKeyManager {
        constructor(_items, injector) {
          if (
            ...
            (this._wrap = !1),
            (this._letterKeyStream = new Subject.B()),
            (this._typeaheadSubscription = Subscription.yU.EMPTY),
            (this._vertical = !0),
            ...
            (this.tabOut = new Subject.B()),
            (this.change = new Subject.B()),
            _items instanceof core.QueryList)
          )
            this._itemChangesSubscription = _items.changes.subscribe(
              (newItems) => this._itemsChanged(newItems.toArray()),
            );
          else if ((0, core.isSignal)(_items)) {
            if (!injector && ("undefined" == typeof ngDevMode || ngDevMode))
              throw new Error(
                "ListKeyManager constructed with a signal must receive an injector",
              );
            this._effectRef = (0, core.effect)(
        ...
        withTypeAhead(debounceInterval = 200) {
          if ("undefined" == typeof ngDevMode || ngDevMode) {
            ...
            if (
              items.length > 0 &&
              items.some((item) => "function" != typeof item.getLabel)
            )
              throw Error(
          ...
          return (
            ...
            (this._typeaheadSubscription = this._letterKeyStream
              .pipe(
                ...
                (0, debounceTime.B)(debounceInterval),
                (0, filter.p)(() => this._pressedLetters.length > 0),
                (0, map.T)(() => this._pressedLetters.join("")),
              )
              .subscribe((inputString) => {
                ...
                for (let i = 1; i < items.length + 1; i++) {
                  ...
                  if (
                    ...
                    0 ===
                      item.getLabel().toUpperCase().trim().indexOf(inputString)
                  ) {
        ...
        withHomeAndEnd(enabled = !0) {
          return (this._homeAndEnd = enabled), this;
        }
        withPageUpDown(enabled = !0, delta = 10) {
          return (this._pageUpAndDown = { enabled, delta }), this;
        }
        setActiveItem(item) {
          const previousActiveItem = this._activeItem;
          this.updateActiveItem(item),
            this._activeItem !== previousActiveItem &&
        ...
        onKeydown(event) {
          const keyCode = event.keyCode,
            isModifierAllowed = [
              ...
              (modifier) =>
                !event[modifier] ||
                this._allowedModifierKeys.indexOf(modifier) > -1,
            );
          switch (keyCode) {
            case keycodes.wn:
            ...
            case keycodes.w_:
              if (this._pageUpAndDown.enabled && isModifierAllowed) {
                const targetIndex =
                  this._activeItemIndex - this._pageUpAndDown.delta;
            ...
            case keycodes.dB:
              if (this._pageUpAndDown.enabled && isModifierAllowed) {
                const targetIndex =
                    this._activeItemIndex + this._pageUpAndDown.delta,
                  itemsLength = this._getItemsArray().length;
                this._setActiveItemByIndex(
            ...
            default:
              return void (
                (isModifierAllowed || (0, keycodes.rp)(event, "shiftKey")) &&
                (event.key && 1 === event.key.length
                  ? this._letterKeyStream.next(event.key.toLocaleUpperCase())
                  : ((keyCode >= keycodes.A && keyCode <= keycodes.Z) ||
                      (keyCode >= keycodes.f2 && keyCode <= keycodes.bn)) &&
        ...
        updateActiveItem(item) {
          ...
          (this._activeItem = null == activeItem ? null : activeItem),
        ...
        _setActiveInWrapMode(delta) {
          ...
          for (let i = 1; i <= items.length; i++) {
            const index =
                (this._activeItemIndex + delta * i + items.length) %
                items.length,
              item = items[index];
            if (!this._skipPredicateFn(item))
              return void this.setActiveItem(index);
          }
        }
        ...
        _getItemsArray() {
          return (0, core.isSignal)(this._items)
            ? this._items()
            : this._items instanceof core.QueryList
              ? this._items.toArray()
              : this._items;
        }
      ...
      class InteractivityChecker {
        ...
        isTabbable(element) {
          ...
          const frameElement = (function getFrameElement(window) {
            try {
          ...
          if (frameElement) {
            ...
            if (!this.isVisible(frameElement)) return !1;
          }
          ...
          return element.hasAttribute("contenteditable")
            ...
            : "iframe" !== nodeName &&
                ...
                ("audio" === nodeName
                  ? !!element.hasAttribute("controls") && -1 !== tabIndexValue
                  : "video" === nodeName
                    ? -1 !== tabIndexValue &&
                      (null !== tabIndexValue ||
        ...
        static #_ = (this.ɵfac = function InteractivityChecker_Factory(t) {
          return new (t || InteractivityChecker)(
            core["ɵɵinject"](fesm2022_platform.OD),
          );
        });
        static #_2 = (this.ɵprov = core["ɵɵdefineInjectable"]({
      ...
      function hasValidTabIndex(element) {
        if (!element.hasAttribute("tabindex") || void 0 === element.tabIndex)
          return !1;
      ...
      class FocusTrap {
        ...
        focusInitialElementWhenReady(options) {
          return new Promise((resolve) => {
            this._executeOnStable(() =>
              resolve(this.focusInitialElement(options)),
            );
          });
        }
          ...
          if (redirectToElement) {
            if (
              ...
              const focusableChild =
                this._getFirstTabbableElement(redirectToElement);
              return focusableChild?.focus(options), !!focusableChild;
            }
            return redirectToElement.focus(options), !0;
          }
        ...
        focusFirstTabbableElement(options) {
          ...
          return (
            redirectToElement && redirectToElement.focus(options),
            !!redirectToElement
          );
        }
        ...
        _executeOnStable(fn) {
          this._ngZone.isStable
            ? fn()
            : this._ngZone.onStable.pipe((0, take.s)(1)).subscribe(fn);
        }
      }
      class FocusTrapFactory {
        ...
        static #_ = (this.ɵfac = function FocusTrapFactory_Factory(t) {
          return new (t || FocusTrapFactory)(
            core["ɵɵinject"](InteractivityChecker),
            core["ɵɵinject"](core.NgZone),
            core["ɵɵinject"](common.DOCUMENT),
          );
        });
      ...
      class CdkTrapFocus {
        ...
        set enabled(value) {
          this.focusTrap && (this.focusTrap.enabled = value);
        }
        constructor(_elementRef, _focusTrapFactory, _document) {
          (this._elementRef = _elementRef),
            (this._focusTrapFactory = _focusTrapFactory),
            (this._previouslyFocusedElement = null);
          (0, core.inject)(fesm2022_platform.OD).isBrowser &&
        ...
        _captureFocus() {
          (this._previouslyFocusedElement = (0, fesm2022_platform.vc)()),
            this.focusTrap?.focusInitialElementWhenReady();
        }
        static #_ = (this.ɵfac = function CdkTrapFocus_Factory(t) {
          return new (t || CdkTrapFocus)(
            core["ɵɵdirectiveInject"](core.ElementRef),
            core["ɵɵdirectiveInject"](FocusTrapFactory),
            ...
            enabled: [
              {
                type: core.Input,
                args: [
                  { alias: "cdkTrapFocus", transform: core.booleanAttribute },
                ],
              },
            ],
            autoCapture: [
      ...
      const FOCUS_TRAP_INERT_STRATEGY = new core.InjectionToken(
      ...
      class EventListenerFocusTrapInertStrategy {
        ...
        preventFocus(focusTrap) {
          this._listener &&
            focusTrap._document.removeEventListener(
              "focus",
              this._listener,
              !0,
            ),
            ...
            focusTrap._ngZone.runOutsideAngular(() => {
              focusTrap._document.addEventListener("focus", this._listener, !0);
            });
        }
        ...
        _trapFocus(focusTrap, event) {
          const target = event.target,
            focusTrapRoot = focusTrap._element;
          !target ||
      ...
      class FocusTrapManager {
        ...
        register(focusTrap) {
          ...
          stack.length && stack[stack.length - 1]._disable(),
        ...
        deregister(focusTrap) {
          ...
          const stack = this._focusTrapStack,
            i = stack.indexOf(focusTrap);
          -1 !== i &&
            (stack.splice(i, 1),
            stack.length && stack[stack.length - 1]._enable());
        }
      ...
      class ConfigurableFocusTrapFactory {
        ...
        create(element, config = { defer: !1 }) {
          let configObject;
          return (
            (configObject =
              "boolean" == typeof config ? { defer: config } : config),
            new ConfigurableFocusTrap(
              element,
              this._checker,
              this._ngZone,
              this._document,
        ...
        static #_ = (this.ɵfac = function ConfigurableFocusTrapFactory_Factory(
          t,
        ) {
          return new (t || ConfigurableFocusTrapFactory)(
            core["ɵɵinject"](InteractivityChecker),
            core["ɵɵinject"](core.NgZone),
            core["ɵɵinject"](FocusTrapManager),
            core["ɵɵinject"](common.DOCUMENT),
            core["ɵɵinject"](FOCUS_TRAP_INERT_STRATEGY, 8),
          );
        });
        static #_2 = (this.ɵprov = core["ɵɵdefineInjectable"]({
      ...
      function isFakeMousedownFromScreenReader(event) {
        return 0 === event.buttons || 0 === event.detail;
      }
      function isFakeTouchstartFromScreenReader(event) {
        ...
        return !(
          !touch ||
          -1 !== touch.identifier ||
          (null != touch.radiusX && 1 !== touch.radiusX) ||
          (null != touch.radiusY && 1 !== touch.radiusY)
        );
      }
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          ...
          () => [
            ...
            },
            {
              ...
              decorators: [
                { type: core.Optional },
                { type: core.Inject, args: [FOCUS_TRAP_INERT_STRATEGY] },
              ],
            },
          ],
          null,
        );
      const INPUT_MODALITY_DETECTOR_OPTIONS = new core.InjectionToken(
        ...
        modalityEventListenerOptions = (0, fesm2022_platform.BQ)({
          passive: !0,
          capture: !0,
        });
      class InputModalityDetector {
        ...
        constructor(_platform, ngZone, document, options) {
          (this._platform = _platform),
            ...
            (this._modality = new BehaviorSubject.t(null)),
            (this._lastTouchMs = 0),
            (this._onKeydown = (event) => {
              this._options?.ignoreKeys?.some(
                ...
                (this._mostRecentTarget = (0, fesm2022_platform.Fb)(event)));
            }),
            ...
            (this.modalityDetected = this._modality.pipe((0, skip.i)(1))),
        ...
        static #_ = (this.ɵfac = function InputModalityDetector_Factory(t) {
          return new (t || InputModalityDetector)(
            core["ɵɵinject"](fesm2022_platform.OD),
            core["ɵɵinject"](core.NgZone),
            core["ɵɵinject"](common.DOCUMENT),
            core["ɵɵinject"](INPUT_MODALITY_DETECTOR_OPTIONS, 8),
          );
        });
        static #_2 = (this.ɵprov = core["ɵɵdefineInjectable"]({
        ...
        core["ɵsetClassMetadata"](
          ...
          () => [
            ...
            },
            {
              ...
              decorators: [
                { type: core.Optional },
                { type: core.Inject, args: [INPUT_MODALITY_DETECTOR_OPTIONS] },
              ],
            },
          ],
          null,
        );
      const LIVE_ANNOUNCER_ELEMENT_TOKEN = new core.InjectionToken(
        "liveAnnouncerElement",
        {
          providedIn: "root",
          factory: function LIVE_ANNOUNCER_ELEMENT_TOKEN_FACTORY() {
            return null;
          },
        },
      );
      const LIVE_ANNOUNCER_DEFAULT_OPTIONS = new core.InjectionToken(
      ...
      class LiveAnnouncer {
        ...
        _createLiveElement() {
          const previousElements = this._document.getElementsByClassName(
        ...
        _exposeAnnouncerToModals(id) {
          ...
          for (let i = 0; i < modals.length; i++) {
            const modal = modals[i],
              ariaOwns = modal.getAttribute("aria-owns");
            ariaOwns
              ? -1 === ariaOwns.indexOf(id) &&
                modal.setAttribute("aria-owns", ariaOwns + " " + id)
              : modal.setAttribute("aria-owns", id);
          }
        }
        static #_ = (this.ɵfac = function LiveAnnouncer_Factory(t) {
          return new (t || LiveAnnouncer)(
            core["ɵɵinject"](LIVE_ANNOUNCER_ELEMENT_TOKEN, 8),
            core["ɵɵinject"](core.NgZone),
            core["ɵɵinject"](common.DOCUMENT),
            core["ɵɵinject"](LIVE_ANNOUNCER_DEFAULT_OPTIONS, 8),
          );
        });
        static #_2 = (this.ɵprov = core["ɵɵdefineInjectable"]({
          token: LiveAnnouncer,
          ...
          () => [
            {
              ...
              decorators: [
                { type: core.Optional },
                { type: core.Inject, args: [LIVE_ANNOUNCER_ELEMENT_TOKEN] },
              ],
            },
            { type: core.NgZone },
            {
            ...
            },
            {
              ...
              decorators: [
                { type: core.Optional },
                { type: core.Inject, args: [LIVE_ANNOUNCER_DEFAULT_OPTIONS] },
              ],
            },
          ],
          null,
      ...
      class CdkAriaLive {
        ...
        set politeness(value) {
          (this._politeness =
            "off" === value || "assertive" === value ? value : "polite"),
                ...
                (this._subscription = this._ngZone.runOutsideAngular(() =>
                  this._contentObserver
                    ...
                    .subscribe(() => {
                      ...
                      elementText !== this._previousAnnouncedText &&
        ...
        static #_ = (this.ɵfac = function CdkAriaLive_Factory(t) {
          return new (t || CdkAriaLive)(
            core["ɵɵdirectiveInject"](core.ElementRef),
            core["ɵɵdirectiveInject"](LiveAnnouncer),
            core["ɵɵdirectiveInject"](observers.io),
      ...
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          ...
          ],
          {
            ...
            duration: [{ type: core.Input, args: ["cdkAriaLiveDuration"] }],
          },
        ),
        (function (FocusMonitorDetectionMode) {
          (FocusMonitorDetectionMode[
            (FocusMonitorDetectionMode.IMMEDIATE = 0)
          ] = "IMMEDIATE"),
            (FocusMonitorDetectionMode[
              (FocusMonitorDetectionMode.EVENTUAL = 1)
            ] = "EVENTUAL");
        })(FocusMonitorDetectionMode || (FocusMonitorDetectionMode = {}));
      const FOCUS_MONITOR_DEFAULT_OPTIONS = new core.InjectionToken(
          "cdk-focus-monitor-default-options",
        ),
        captureEventListenerOptions = (0, fesm2022_platform.BQ)({
          passive: !0,
          capture: !0,
        });
      class FocusMonitor {
        constructor(
          ...
          (this._ngZone = _ngZone),
            ...
            (this._stopInputModalityDetector = new Subject.B()),
            (this._rootNodeFocusAndBlurListener = (event) => {
              for (
                let element = (0, fesm2022_platform.Fb)(event);
                element;
        ...
        monitor(element, checkChildren = !1) {
          const nativeElement = (0, coercion.i8)(element);
          if (!this._platform.isBrowser || 1 !== nativeElement.nodeType)
            return (0, of.of)();
          const rootNode =
              (0, fesm2022_platform.KT)(nativeElement) || this._getDocument(),
            cachedInfo = this._elementInfo.get(nativeElement);
          if (cachedInfo)
            return (
              checkChildren && (cachedInfo.checkChildren = !0),
              cachedInfo.subject
            );
          const info = { checkChildren, subject: new Subject.B(), rootNode };
          return (
        ...
        _getFocusOrigin(focusEventTarget) {
          return this._origin
            ? this._originFromTouchInteraction
              ? this._shouldBeAttributedToTouch(focusEventTarget)
                ? "touch"
                : "program"
              : this._origin
        ...
        _setClasses(element, origin) {
          element.classList.toggle("cdk-focused", !!origin),
            element.classList.toggle("cdk-touch-focused", "touch" === origin),
            element.classList.toggle(
              "cdk-keyboard-focused",
              "keyboard" === origin,
            ),
            element.classList.toggle("cdk-mouse-focused", "mouse" === origin),
            element.classList.toggle(
              "cdk-program-focused",
              "program" === origin,
            );
        }
        _setOrigin(origin, isFromInteraction = !1) {
          this._ngZone.runOutsideAngular(() => {
            if (
              ((this._origin = origin),
              (this._originFromTouchInteraction =
                "touch" === origin && isFromInteraction),
              this._detectionMode === FocusMonitorDetectionMode.IMMEDIATE)
            ) {
              clearTimeout(this._originTimeoutId);
              const ms = this._originFromTouchInteraction ? 650 : 1;
        ...
        _onFocus(event, element) {
          const elementInfo = this._elementInfo.get(element),
            focusEventTarget = (0, fesm2022_platform.Fb)(event);
          elementInfo &&
        ...
        _onBlur(event, element) {
          ...
          !elementInfo ||
            ...
            (this._setClasses(element), this._emitOrigin(elementInfo, null));
        }
        _emitOrigin(info, origin) {
          info.subject.observers.length &&
            this._ngZone.run(() => info.subject.next(origin));
        }
        _registerGlobalListeners(elementInfo) {
          if (!this._platform.isBrowser) return;
          const rootNode = elementInfo.rootNode,
            rootNodeFocusListeners =
          ...
          rootNodeFocusListeners ||
            ...
            1 == ++this._monitoredElementCount &&
              ...
              this._inputModalityDetector.modalityDetected
                .pipe((0, takeUntil.Q)(this._stopInputModalityDetector))
                .subscribe((modality) => {
                  this._setOrigin(modality, !0);
                }));
        }
        ...
        _isLastInteractionFromInputLabel(focusEventTarget) {
          ...
          if (
            "mouse" !== mostRecentModality ||
            !mostRecentTarget ||
            mostRecentTarget === focusEventTarget ||
            ("INPUT" !== focusEventTarget.nodeName &&
              "TEXTAREA" !== focusEventTarget.nodeName) ||
          ...
          if (labels)
            for (let i = 0; i < labels.length; i++)
              if (labels[i].contains(mostRecentTarget)) return !0;
          return !1;
        }
        static #_ = (this.ɵfac = function FocusMonitor_Factory(t) {
          return new (t || FocusMonitor)(
            core["ɵɵinject"](core.NgZone),
            core["ɵɵinject"](fesm2022_platform.OD),
            core["ɵɵinject"](InputModalityDetector),
            core["ɵɵinject"](common.DOCUMENT, 8),
            core["ɵɵinject"](FOCUS_MONITOR_DEFAULT_OPTIONS, 8),
          );
        });
        static #_2 = (this.ɵprov = core["ɵɵdefineInjectable"]({
          token: FocusMonitor,
        ...
        core["ɵsetClassMetadata"](
          ...
          () => [
            ...
            },
            {
              ...
              decorators: [
                { type: core.Optional },
                { type: core.Inject, args: [FOCUS_MONITOR_DEFAULT_OPTIONS] },
              ],
            },
          ],
          null,
      ...
      class CdkMonitorFocus {
        ...
        ngAfterViewInit() {
          ...
          this._monitorSubscription = this._focusMonitor
            ...
            .subscribe((origin) => {
              (this._focusOrigin = origin), this.cdkFocusChange.emit(origin);
            });
        }
        ngOnDestroy() {
        ...
        static #_ = (this.ɵfac = function CdkMonitorFocus_Factory(t) {
          return new (t || CdkMonitorFocus)(
            core["ɵɵdirectiveInject"](core.ElementRef),
            core["ɵɵdirectiveInject"](FocusMonitor),
          );
        });
        static #_2 = (this.ɵdir = core["ɵɵdefineDirective"]({
      ...
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          ...
          () => [{ type: core.ElementRef }, { type: FocusMonitor }],
          { cdkFocusChange: [{ type: core.Output }] },
        ),
        (function (HighContrastMode) {
          (HighContrastMode[(HighContrastMode.NONE = 0)] = "NONE"),
            (HighContrastMode[(HighContrastMode.BLACK_ON_WHITE = 1)] =
              "BLACK_ON_WHITE"),
            (HighContrastMode[(HighContrastMode.WHITE_ON_BLACK = 2)] =
              "WHITE_ON_BLACK");
      ...
      class HighContrastModeDetector {
        constructor(_platform, document) {
          (this._platform = _platform),
            (this._document = document),
            (this._breakpointSubscription = (0, core.inject)(BreakpointObserver)
        ...
        getHighContrastMode() {
          ...
          switch ((testElement.remove(), computedColor)) {
            case "rgb(0,0,0)":
            case "rgb(45,50,54)":
            case "rgb(32,32,32)":
        ...
        _applyBodyHighContrastModeCssClasses() {
          if (
            ...
            mode === HighContrastMode.BLACK_ON_WHITE
              ? bodyClasses.add(
                  "cdk-high-contrast-active",
                  "cdk-high-contrast-black-on-white",
                )
              : mode === HighContrastMode.WHITE_ON_BLACK &&
                bodyClasses.add(
                  "cdk-high-contrast-active",
                  "cdk-high-contrast-white-on-black",
                );
        ...
        static #_ = (this.ɵfac = function HighContrastModeDetector_Factory(t) {
          return new (t || HighContrastModeDetector)(
            core["ɵɵinject"](fesm2022_platform.OD),
            core["ɵɵinject"](common.DOCUMENT),
          );
        });
      ...
      class A11yModule {
        ...
        static #_ = (this.ɵfac = function A11yModule_Factory(t) {
          return new (t || A11yModule)(
            core["ɵɵinject"](HighContrastModeDetector),
          );
        });
        static #_2 = (this.ɵmod = core["ɵɵdefineNgModule"]({
          type: A11yModule,
          imports: [observers.w5, CdkAriaLive, CdkTrapFocus, CdkMonitorFocus],
          exports: [CdkAriaLive, CdkTrapFocus, CdkMonitorFocus],
        }));
        static #_3 = (this.ɵinj = core["ɵɵdefineInjector"]({
          imports: [observers.w5],
        }));
      }
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
    ...
    "./node_modules/@angular/cdk/fesm2022/bidi.mjs": (
      ...
      class BidiModule {
        ...
        static #_2 = (this.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__[
          "ɵɵdefineNgModule"
        ]({ type: BidiModule, imports: [Dir], exports: [Dir] }));
    ...
    "./node_modules/@angular/cdk/fesm2022/coercion.mjs": (
      ...
      __webpack_require__.d(__webpack_exports__, {
        FG: () => coerceArray,
        OE: () => coerceNumberProperty,
        a1: () => coerceCssPixelValue,
        he: () => coerceBooleanProperty,
        i8: () => coerceElement,
      });
      var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        "./node_modules/@angular/core/fesm2022/core.mjs",
      ...
      function coerceNumberProperty(value, fallbackValue = 0) {
        return (function _isNumberValue(value) {
    ...
    "./node_modules/@angular/cdk/fesm2022/observers.mjs": (
      ...
      __webpack_require__.d(__webpack_exports__, {
        Wv: () => CdkObserveContent,
        io: () => ContentObserver,
        w5: () => ObserversModule,
      });
      var _angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            "./node_modules/@angular/cdk/fesm2022/coercion.mjs",
          ),
        ...
        rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          "./node_modules/rxjs/dist/esm5/internal/Subject.js",
        ),
        ...
        rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          "./node_modules/rxjs/dist/esm5/internal/operators/debounceTime.js",
        );
      ...
      class ContentObserver {
        ...
        observe(elementOrRef) {
          const element = (0,
          _angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_1__.i8)(elementOrRef);
          return new rxjs__WEBPACK_IMPORTED_MODULE_2__.c((observer) => {
            const subscription = this._observeElement(element)
              .pipe(
                (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.T)((records) =>
                  records.filter(
                    (record) =>
                      !(function shouldIgnoreRecord(record) {
                        if (
                          "characterData" === record.type &&
                          record.target instanceof Comment
                        )
                          return !0;
                ...
                (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.p)(
        ...
        _observeElement(element) {
          if (this._observedElements.has(element))
            ...
            const stream = new rxjs__WEBPACK_IMPORTED_MODULE_5__.B(),
              observer = this._mutationObserverFactory.create((mutations) =>
        ...
        _unobserveElement(element) {
          this._observedElements.has(element) &&
            (this._observedElements.get(element).count--,
            this._observedElements.get(element).count ||
              this._cleanupObserver(element));
        }
      ...
      class CdkObserveContent {
        ...
        set debounce(value) {
          (this._debounce = (0,
          _angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_1__.OE)(value)),
            this._subscribe();
        }
        ...
        _subscribe() {
          ...
          this._ngZone.runOutsideAngular(() => {
            this._currentSubscription = (
              this.debounce
                ? stream.pipe(
                    (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.B)(
                      this.debounce,
                    ),
                  )
                : stream
        ...
        static #_ = (this.ɵfac = function CdkObserveContent_Factory(t) {
          return new (t || CdkObserveContent)(
    ...
    "./node_modules/@angular/cdk/fesm2022/platform.mjs": (
      ...
      __webpack_require__.d(__webpack_exports__, {
        BD: () => getRtlScrollAxisType,
        BQ: () => normalizePassiveListenerOptions,
        CZ: () => supportsScrollBehavior,
        Fb: () => _getEventTarget,
        KT: () => _getShadowRoot,
        MU: () => getSupportedInputTypes,
        OD: () => Platform,
        r5: () => RtlScrollAxisType,
        v8: () => _isTestEnvironment,
        vc: () => _getFocusedElementPierceShadowDom,
      });
      var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          "./node_modules/@angular/core/fesm2022/core.mjs",
        ),
        _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          "./node_modules/@angular/common/fesm2022/common.mjs",
        );
      let hasV8BreakIterator, supportedInputTypes;
      try {
      ...
      class Platform {
        ...
        static #_2 = (this.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__[
          "ɵɵdefineInjectable"
        ]({ token: Platform, factory: Platform.ɵfac, providedIn: "root" }));
      }
      ("undefined" == typeof ngDevMode || ngDevMode) &&
      ...
      function normalizePassiveListenerOptions(options) {
        return (function supportsPassiveEventListeners() {
          if (null == supportsPassiveEvents && "undefined" != typeof window)
            try {
      ...
      let rtlScrollAxisType, scrollBehaviorSupported, shadowDomIsSupported;
      function supportsScrollBehavior() {
        if (null == scrollBehaviorSupported) {
          if (
            ...
            return (scrollBehaviorSupported = !1), scrollBehaviorSupported;
          if ("scrollBehavior" in document.documentElement.style)
            scrollBehaviorSupported = !0;
          else {
            const scrollToFunction = Element.prototype.scrollTo;
            scrollBehaviorSupported =
              !!scrollToFunction &&
              !/\{\s*\[native code\]\s*\}/.test(scrollToFunction.toString());
          }
        }
      ...
      function _getFocusedElementPierceShadowDom() {
        let activeElement =
          "undefined" != typeof document && document
            ...
            : null;
        for (; activeElement && activeElement.shadowRoot; ) {
    ...
    "./node_modules/@angular/material/fesm2022/core.mjs": (
      ...
      __webpack_require__.d(__webpack_exports__, {
        es: () => ErrorStateMatcher,
        QC: () => MAT_OPTGROUP,
        is: () => MAT_OPTION_PARENT_COMPONENT,
        $E: () => MAT_RIPPLE_GLOBAL_OPTIONS,
        yE: () => MatCommonModule,
        wT: () => MatOption,
        Sy: () => MatOptionModule,
        MI: () => MatOptionSelectionChange,
        r6: () => MatRipple,
        Ej: () => MatRippleLoader,
        pZ: () => MatRippleModule,
        X0: () => _ErrorStateTracker,
        tO: () => _MatInternalFormField,
        jb: () => _countGroupLabelsBeforeOption,
        TL: () => _getOptionScrollPosition,
      });
      ...
      const VERSION = new core.Version("17.3.10");
      var common = __webpack_require__(
          "./node_modules/@angular/common/fesm2022/common.mjs",
        ),
        fesm2022_platform = __webpack_require__(
      ...
      const _c0 = ["*", [["mat-option"], ["ng-container"]]],
        _c1 = ["*", "mat-option, ng-container"],
        _c2 = ["text"],
        _c3 = [[["mat-icon"]], "*"],
        _c4 = ["mat-icon", "*"];
      function MatOption_Conditional_0_Template(rf, ctx) {
        if (
          (1 & rf && core["ɵɵelement"](0, "mat-pseudo-checkbox", 1), 2 & rf)
        ) {
          const ctx_r0 = core["ɵɵnextContext"]();
          core["ɵɵproperty"]("disabled", ctx_r0.disabled)(
            "state",
      ...
      function MatOption_Conditional_5_Template(rf, ctx) {
        if (
          (1 & rf && core["ɵɵelement"](0, "mat-pseudo-checkbox", 3), 2 & rf)
        ) {
          const ctx_r0 = core["ɵɵnextContext"]();
          core["ɵɵproperty"]("disabled", ctx_r0.disabled);
        }
      ...
      function MatOption_Conditional_6_Template(rf, ctx) {
        if (
          ...
          const ctx_r0 = core["ɵɵnextContext"]();
          core["ɵɵadvance"](),
            core["ɵɵtextInterpolate1"]("(", ctx_r0.group.label, ")");
        }
      }
      const _c5 = ["mat-internal-form-field", ""],
        _c6 = ["*"],
        core_VERSION = new core.Version("17.3.10");
      ...
      const MATERIAL_SANITY_CHECKS = new core.InjectionToken(
        "mat-sanity-checks",
        {
          providedIn: "root",
          factory: function MATERIAL_SANITY_CHECKS_FACTORY() {
            return !0;
          },
        },
      );
      class MatCommonModule {
        constructor(highContrastModeDetector, _sanityChecks, _document) {
          if (
            ...
            const platform = (0, core.inject)(fesm2022_platform.OD, {
              optional: !0,
            });
            this._checkIsEnabled("doctype") &&
              ...
              this._checkIsEnabled("theme") &&
                (function _checkThemeIsPresent(doc, isBrowser) {
                  ...
                  testElement.remove();
                })(this._document, !!platform?.isBrowser),
              this._checkIsEnabled("version") &&
                (function _checkCdkVersionMatch() {
                  core_VERSION.full !== VERSION.full &&
                    console.warn(
        ...
        _checkIsEnabled(name) {
          return (
            !(0, fesm2022_platform.v8)() &&
            ("boolean" == typeof this._sanityChecks
              ? this._sanityChecks
              : !!this._sanityChecks[name])
          );
        }
        static #_ = (this.ɵfac = function MatCommonModule_Factory(t) {
          return new (t || MatCommonModule)(
            core["ɵɵinject"](a11y.Q_),
            core["ɵɵinject"](MATERIAL_SANITY_CHECKS, 8),
            core["ɵɵinject"](common.DOCUMENT),
          );
        });
        static #_2 = (this.ɵmod = core["ɵɵdefineNgModule"]({
      ...
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          ...
          [
            {
              type: core.NgModule,
              args: [{ imports: [bidi.jI], exports: [bidi.jI] }],
            },
          ],
          () => [
            { type: a11y.Q_ },
      ...
      class _ErrorStateTracker {
        ...
        updateErrorState() {
          const oldState = this.errorState,
            ...
            matcher = this.matcher || this._defaultMatcher,
            control = this.ngControl ? this.ngControl.control : null,
            newState = matcher?.isErrorState(control, parent) ?? !1;
          newState !== oldState &&
            ((this.errorState = newState), this._stateChanges.next());
        }
      }
      const MAT_DATE_LOCALE = new core.InjectionToken("MAT_DATE_LOCALE", {
        providedIn: "root",
        factory: function MAT_DATE_LOCALE_FACTORY() {
          return (0, core.inject)(core.LOCALE_ID);
        },
      });
      class DateAdapter {
        constructor() {
          (this._localeChanges = new Subject.B()),
      ...
      class NativeDateAdapter extends DateAdapter {
        constructor(matDateLocale) {
          super(),
            ...
            (this._matDateLocale = (0, core.inject)(MAT_DATE_LOCALE, {
              optional: !0,
            })),
            void 0 !== matDateLocale && (this._matDateLocale = matDateLocale),
        ...
        addCalendarYears(date, years) {
          return this.addCalendarMonths(date, 12 * years);
        }
        ...
        _createDateWithOverflow(year, month, date) {
          const d = new Date();
          return d.setFullYear(year, month, date), d.setHours(0, 0, 0, 0), d;
        }
        _2digit(n) {
          return ("00" + n).slice(-2);
        }
        ...
        static #_ = (this.ɵfac = function NativeDateAdapter_Factory(t) {
          return new (t || NativeDateAdapter)(
            core["ɵɵinject"](MAT_DATE_LOCALE, 8),
          );
        });
        static #_2 = (this.ɵprov = core["ɵɵdefineInjectable"]({
          ...
          () => [
            {
              ...
              decorators: [
                { type: core.Optional },
                { type: core.Inject, args: [MAT_DATE_LOCALE] },
              ],
            },
          ],
          null,
      ...
      class ShowOnDirtyErrorStateMatcher {
        ...
        static #_ = (this.ɵfac = function ShowOnDirtyErrorStateMatcher_Factory(
          t,
        ) {
      ...
      class RippleRef {
        constructor(
          ...
          element,
          config,
          _animationForciblyDisabledThroughCss = !1,
        ) {
      ...
      const passiveCapturingEventOptions$1 = (0, fesm2022_platform.BQ)({
        passive: !0,
        capture: !0,
      });
      class RippleEventManager {
        constructor() {
          (this._events = new Map()),
            (this._delegateEventHandler = (event) => {
              const target = (0, fesm2022_platform.Fb)(event);
              target &&
        ...
        removeHandler(name, element, handler) {
          ...
          handlersForElement &&
            ...
            0 === handlersForElement.size && handlersForEvent.delete(element),
            0 === handlersForEvent.size &&
      ...
      const defaultRippleAnimationConfig = {
        ...
        passiveCapturingEventOptions = (0, fesm2022_platform.BQ)({
          passive: !0,
          capture: !0,
        }),
      ...
      class RippleRenderer {
        ...
        constructor(_target, _ngZone, elementOrElementRef, _platform) {
          (this._target = _target),
            ...
            _platform.isBrowser &&
              (this._containerElement = (0, coercion.i8)(elementOrElementRef));
        }
        fadeInRipple(x, y, config = {}) {
          ...
          const computedStyles = window.getComputedStyle(ripple),
            userTransitionProperty = computedStyles.transitionProperty,
            userTransitionDuration = computedStyles.transitionDuration,
            animationForciblyDisabledThroughCss =
              "none" === userTransitionProperty ||
              "0s" === userTransitionDuration ||
              "0s, 0s" === userTransitionDuration ||
              (0 === containerRect.width && 0 === containerRect.height),
            rippleRef = new RippleRef(
              this,
              ripple,
              config,
              animationForciblyDisabledThroughCss,
          ...
          (ripple.style.transform = "scale3d(1, 1, 1)"),
            ...
            config.persistent || (this._mostRecentTransientRipple = rippleRef);
          ...
          return (
            animationForciblyDisabledThroughCss ||
              ...
              this._ngZone.runOutsideAngular(() => {
                const onTransitionEnd = () =>
                  ...
                  onTransitionCancel = () => this._destroyRipple(rippleRef);
            ...
            (!animationForciblyDisabledThroughCss && enterDuration) ||
              this._finishRippleTransition(rippleRef),
            rippleRef
          );
        }
        ...
        fadeOutAllNonPersistent() {
          this._getActiveRipples().forEach((ripple) => {
            ripple.config.persistent || ripple.fadeOut();
          });
        }
        setupTriggerEvents(elementOrElementRef) {
          const element = (0, coercion.i8)(elementOrElementRef);
          this._platform.isBrowser &&
            element &&
        ...
        _onMousedown(event) {
          const isFakeMousedown = (0, a11y._G)(event),
            isSyntheticEvent =
        ...
        _onTouchStart(event) {
          if (!this._target.rippleDisabled && !(0, a11y.w6)(event)) {
      ...
      const MAT_RIPPLE_GLOBAL_OPTIONS = new core.InjectionToken(
      ...
      class MatRipple {
        ...
        set disabled(value) {
          value && this.fadeOutAllNonPersistent(),
            (this._disabled = value),
        ...
        launch(configOrX, y = 0, config) {
          return "number" == typeof configOrX
            ? this._rippleRenderer.fadeInRipple(configOrX, y, {
                ...this.rippleConfig,
                ...config,
              })
        ...
        static #_ = (this.ɵfac = function MatRipple_Factory(t) {
          return new (t || MatRipple)(
            core["ɵɵdirectiveInject"](core.ElementRef),
            core["ɵɵdirectiveInject"](core.NgZone),
            core["ɵɵdirectiveInject"](fesm2022_platform.OD),
            core["ɵɵdirectiveInject"](MAT_RIPPLE_GLOBAL_OPTIONS, 8),
        ...
        static #_2 = (this.ɵdir = core["ɵɵdefineDirective"]({
          ...
          inputs: {
            color: [core["ɵɵInputFlags"].None, "matRippleColor", "color"],
            unbounded: [
              core["ɵɵInputFlags"].None,
              "matRippleUnbounded",
              "unbounded",
            ...
            radius: [core["ɵɵInputFlags"].None, "matRippleRadius", "radius"],
            animation: [
              core["ɵɵInputFlags"].None,
              "matRippleAnimation",
              "animation",
            ...
            trigger: [core["ɵɵInputFlags"].None, "matRippleTrigger", "trigger"],
          },
          exportAs: ["matRipple"],
          standalone: !0,
        }));
          ...
          hostBindings: function MatPseudoCheckbox_HostBindings(rf, ctx) {
            2 & rf &&
              core["ɵɵclassProp"](
                ...
                "indeterminate" === ctx.state,
              )("mat-pseudo-checkbox-checked", "checked" === ctx.state)(
                "mat-pseudo-checkbox-disabled",
                ctx.disabled,
              )("mat-pseudo-checkbox-minimal", "minimal" === ctx.appearance)(
              ...
              args: [
                {
                  ...
                  host: {
                    ...
                    "[class.mat-pseudo-checkbox-indeterminate]":
                      'state === "indeterminate"',
                    "[class.mat-pseudo-checkbox-checked]":
                      'state === "checked"',
      ...
      const MAT_OPTION_PARENT_COMPONENT = new core.InjectionToken(
      ...
      class MatOptgroup {
        constructor(parent) {
          (this.disabled = !1),
            ...
            (this._inert = parent?.inertGroups ?? !1);
        }
        static #_ = (this.ɵfac = function MatOptgroup_Factory(t) {
          return new (t || MatOptgroup)(
            core["ɵɵdirectiveInject"](MAT_OPTION_PARENT_COMPONENT, 8),
          );
        });
        static #_2 = (this.ɵcmp = core["ɵɵdefineComponent"]({
          type: MatOptgroup,
          ...
          hostBindings: function MatOptgroup_HostBindings(rf, ctx) {
            2 & rf &&
              core["ɵɵattribute"]("role", ctx._inert ? null : "group")(
                "aria-disabled",
          ...
          template: function MatOptgroup_Template(rf, ctx) {
            1 & rf &&
              ...
              core["ɵɵelementStart"](0, "span", 0)(1, "span", 1),
              core["ɵɵtext"](2),
              core["ɵɵprojection"](3),
              core["ɵɵelementEnd"]()(),
              core["ɵɵprojection"](4, 1)),
              2 & rf &&
                (core["ɵɵclassProp"]("mdc-list-item--disabled", ctx.disabled),
          ...
          () => [
            {
              type: void 0,
              decorators: [
                { type: core.Inject, args: [MAT_OPTION_PARENT_COMPONENT] },
                { type: core.Optional },
              ],
            },
          ],
      ...
      class MatOptionSelectionChange {
        constructor(source, isUserInput = !1) {
          (this.source = source), (this.isUserInput = isUserInput);
        }
      }
      class MatOption {
        get multiple() {
        ...
        select(emitEvent = !0) {
          this._selected ||
            ...
            emitEvent && this._emitSelectionChangeEvent());
        }
        deselect(emitEvent = !0) {
          this._selected &&
            ((this._selected = !1),
            this._changeDetectorRef.markForCheck(),
            emitEvent && this._emitSelectionChangeEvent());
        ...
        focus(_origin, options) {
          ...
          "function" == typeof element.focus && element.focus(options);
        }
        setActiveStyles() {
          this._active ||
        ...
        _handleKeydown(event) {
          (event.keyCode !== keycodes.Fm && event.keyCode !== keycodes.t6) ||
            (0, keycodes.rp)(event) ||
            (this._selectViaInteraction(), event.preventDefault());
        }
        ...
        ngAfterViewChecked() {
          if (this._selected) {
            ...
            viewValue !== this._mostRecentViewValue &&
        ...
        _emitSelectionChangeEvent(isUserInput = !1) {
        ...
        static #_ = (this.ɵfac = function MatOption_Factory(t) {
          return new (t || MatOption)(
            ...
            core["ɵɵdirectiveInject"](MAT_OPTION_PARENT_COMPONENT, 8),
            core["ɵɵdirectiveInject"](MAT_OPTGROUP, 8),
          );
        });
        static #_2 = (this.ɵcmp = core["ɵɵdefineComponent"]({
          type: MatOption,
          ...
          viewQuery: function MatOption_Query(rf, ctx) {
            if ((1 & rf && core["ɵɵviewQuery"](_c2, 7), 2 & rf)) {
              let _t;
          ...
          hostBindings: function MatOption_HostBindings(rf, ctx) {
            1 & rf &&
              core["ɵɵlistener"](
                "click",
                function MatOption_click_HostBindingHandler() {
                  return ctx._selectViaInteraction();
                },
              )(
                "keydown",
                function MatOption_keydown_HostBindingHandler($event) {
                  return ctx._handleKeydown($event);
                },
              ),
              2 & rf &&
                (core["ɵɵhostProperty"]("id", ctx.id),
                core["ɵɵattribute"]("aria-selected", ctx.selected)(
                  "aria-disabled",
                  ctx.disabled.toString(),
                ),
                core["ɵɵclassProp"]("mdc-list-item--selected", ctx.selected)(
          ...
          template: function MatOption_Template(rf, ctx) {
            1 & rf &&
              ...
              core["ɵɵprojection"](1),
              core["ɵɵelementStart"](2, "span", 2, 0),
              core["ɵɵprojection"](4, 1),
              core["ɵɵelementEnd"](),
              core["ɵɵtemplate"](
                5,
              ...
              2 & rf &&
                (core["ɵɵconditional"](0, ctx.multiple ? 0 : -1),
                core["ɵɵadvance"](5),
                core["ɵɵconditional"](
                  5,
                  ctx.multiple ||
                    !ctx.selected ||
                    ctx.hideSingleSelectionIndicator
                    ? -1
                    : 5,
                ),
                core["ɵɵadvance"](),
                core["ɵɵconditional"](
                  6,
                  ctx.group && ctx.group._inert ? 6 : -1,
                ),
                core["ɵɵadvance"](),
      ...
      function _getOptionScrollPosition(
        ...
        return optionOffset < currentScrollPosition
          ? optionOffset
          : optionOffset + optionHeight > currentScrollPosition + panelHeight
            ? Math.max(0, optionOffset - panelHeight + optionHeight)
            : currentScrollPosition;
      }
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          ...
          () => [
            ...
            },
            {
              ...
              decorators: [
                { type: core.Optional },
                { type: core.Inject, args: [MAT_OPTGROUP] },
              ],
            },
          ],
          {
            ...
            _text: [{ type: core.ViewChild, args: ["text", { static: !0 }] }],
          },
        );
      ...
      const eventListenerOptions = { capture: !0 },
        rippleInteractionEvents = [
          "focus",
          "click",
          "mouseenter",
          "touchstart",
      ...
      class MatRippleLoader {
        constructor() {
          (this._document = (0, core.inject)(common.DOCUMENT, {
            optional: !0,
          })),
            (this._animationMode = (0, core.inject)(
              core.ANIMATION_MODULE_TYPE,
              { optional: !0 },
            )),
            (this._globalRippleOptions = (0, core.inject)(
              MAT_RIPPLE_GLOBAL_OPTIONS,
              { optional: !0 },
            )),
            (this._platform = (0, core.inject)(fesm2022_platform.OD)),
            ...
            (this._onInteraction = (event) => {
              ...
              element && this._createRipple(element);
            }),
            this._ngZone.runOutsideAngular(() => {
        ...
        configureRipple(host, config) {
          host.setAttribute("mat-ripple-loader-uninitialized", ""),
            (!config.className &&
              host.hasAttribute("mat-ripple-loader-class-name")) ||
              host.setAttribute(
                "mat-ripple-loader-class-name",
                config.className || "",
              ),
            config.centered &&
              host.setAttribute("mat-ripple-loader-centered", ""),
            config.disabled &&
              host.setAttribute("mat-ripple-loader-disabled", "");
        }
        getRipple(host) {
          return this._hosts.get(host) || this._createRipple(host);
        }
        setDisabled(host, disabled) {
          ...
          ripple
            ...
            : disabled
              ? host.setAttribute("mat-ripple-loader-disabled", "")
              : host.removeAttribute("mat-ripple-loader-disabled");
        }
        _createRipple(host) {
          if (!this._document) return;
          const existingRipple = this._hosts.get(host);
          if (existingRipple) return existingRipple;
          host.querySelector(".mat-ripple")?.remove();
          const rippleEl = this._document.createElement("span");
          rippleEl.classList.add(
            "mat-ripple",
            host.getAttribute("mat-ripple-loader-class-name"),
          ),
            host.append(rippleEl);
          const ripple = new MatRipple(
            new core.ElementRef(rippleEl),
            this._ngZone,
            this._platform,
          ...
          return (
            (ripple._isInitialized = !0),
            (ripple.trigger = host),
            (ripple.centered = host.hasAttribute("mat-ripple-loader-centered")),
            (ripple.disabled = host.hasAttribute("mat-ripple-loader-disabled")),
            this.attachRipple(host, ripple),
            ripple
          );
        }
        attachRipple(host, ripple) {
          host.removeAttribute("mat-ripple-loader-uninitialized"),
            this._hosts.set(host, ripple);
        }
        destroyRipple(host) {
          const ripple = this._hosts.get(host);
          ripple && (ripple.ngOnDestroy(), this._hosts.delete(host));
        }
      ...
      ("undefined" == typeof ngDevMode || ngDevMode) &&
        core["ɵsetClassMetadata"](
          ...
          null,
          { labelPosition: [{ type: core.Input, args: [{ required: !0 }] }] },
        );
    },
    "./node_modules/rxjs/dist/esm5/internal/observable/combineLatest.js": (
      __unused_webpack_module,
      ...
      __webpack_require__.d(__webpack_exports__, { z: () => combineLatest });
      var _Observable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          "./node_modules/rxjs/dist/esm5/internal/Observable.js",
        ),
        _util_argsArgArrayOrObject__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            "./node_modules/rxjs/dist/esm5/internal/util/argsArgArrayOrObject.js",
          ),
        _from__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          "./node_modules/rxjs/dist/esm5/internal/observable/from.js",
        ),
        _util_identity__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          "./node_modules/rxjs/dist/esm5/internal/util/identity.js",
        ),
        _util_mapOneOrManyArgs__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
        ...
        _util_createObject__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          "./node_modules/rxjs/dist/esm5/internal/util/createObject.js",
        ),
        _operators_OperatorSubscriber__WEBPACK_IMPORTED_MODULE_7__ =
          __webpack_require__(
            "./node_modules/rxjs/dist/esm5/internal/operators/OperatorSubscriber.js",
          ),
        _util_executeSchedule__WEBPACK_IMPORTED_MODULE_8__ =
          __webpack_require__(
      ...
      function combineLatest() {
        ...
        var scheduler = (0, _util_args__WEBPACK_IMPORTED_MODULE_0__.lI)(args),
          resultSelector = (0, _util_args__WEBPACK_IMPORTED_MODULE_0__.ms)(
            args,
          ),
          _a = (0, _util_argsArgArrayOrObject__WEBPACK_IMPORTED_MODULE_1__.D)(
            args,
          ),
          observables = _a.args,
          keys = _a.keys;
        if (0 === observables.length)
          return (0, _from__WEBPACK_IMPORTED_MODULE_2__.H)([], scheduler);
        var result = new _Observable__WEBPACK_IMPORTED_MODULE_3__.c(
          (function combineLatestInit(observables, scheduler, valueTransform) {
            void 0 === valueTransform &&
              (valueTransform = _util_identity__WEBPACK_IMPORTED_MODULE_5__.D);
                    ...
                    var length = observables.length,
                      ...
                      _loop_1 = function (i) {
                        maybeSchedule(
                          ...
                          function () {
                            var source = (0,
                              _from__WEBPACK_IMPORTED_MODULE_2__.H)(
                                observables[i],
                                scheduler,
                              ),
                              hasFirstValue = !1;
                            source.subscribe(
                              (0,
                              _operators_OperatorSubscriber__WEBPACK_IMPORTED_MODULE_7__._)(
                                subscriber,
                                function (value) {
                                  (values[i] = value),
                                    hasFirstValue ||
            ...
            keys
              ? function (values) {
                  return (0, _util_createObject__WEBPACK_IMPORTED_MODULE_4__.e)(
                    keys,
                    values,
                  );
                }
              : _util_identity__WEBPACK_IMPORTED_MODULE_5__.D,
          ),
        );
        return resultSelector
          ? result.pipe(
              (0, _util_mapOneOrManyArgs__WEBPACK_IMPORTED_MODULE_6__.I)(
                resultSelector,
              ),
            )
          : result;
      ...
      function maybeSchedule(scheduler, execute, subscription) {
        scheduler
          ? (0, _util_executeSchedule__WEBPACK_IMPORTED_MODULE_8__.N)(
              subscription,
              scheduler,
              execute,
            )
    ...
    "./node_modules/rxjs/dist/esm5/internal/operators/debounceTime.js": (
      ...
      __webpack_require__.d(__webpack_exports__, { B: () => debounceTime });
      ...
      function debounceTime(dueTime, scheduler) {
        return (
          void 0 === scheduler &&
            (scheduler = _scheduler_async__WEBPACK_IMPORTED_MODULE_0__.E),
    ...
    "./node_modules/rxjs/dist/esm5/internal/operators/skip.js": (
      ...
      __webpack_require__.d(__webpack_exports__, { i: () => skip });
      var _filter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        "./node_modules/rxjs/dist/esm5/internal/operators/filter.js",
      );
      function skip(count) {
        return (0, _filter__WEBPACK_IMPORTED_MODULE_0__.p)(function (_, index) {
          return count <= index;
        });
      }
    },
    ...
    "./node_modules/rxjs/dist/esm5/internal/util/argsArgArrayOrObject.js": (
      ...
      function argsArgArrayOrObject(args) {
        if (1 === args.length) {
          var first_1 = args[0];
          if (isArray(first_1)) return { args: first_1, keys: null };
          if (
            (function isPOJO(obj) {
              return (
                obj &&
    ...
    "./node_modules/rxjs/dist/esm5/internal/util/createObject.js": (
      ...
      __webpack_require__.d(__webpack_exports__, { e: () => createObject });
    },
    "./node_modules/rxjs/dist/esm5/internal/util/mapOneOrManyArgs.js": (
      __unused_webpack_module,
      __webpack_exports__,
      ...
      __webpack_require__.d(__webpack_exports__, { I: () => mapOneOrManyArgs });
      var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          "./node_modules/tslib/tslib.es6.mjs",
        ),
        _operators_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          "./node_modules/rxjs/dist/esm5/internal/operators/map.js",
        ),
        isArray = Array.isArray;
      function mapOneOrManyArgs(fn) {
        return (0, _operators_map__WEBPACK_IMPORTED_MODULE_1__.T)(
          function (args) {
            return (function callOrApply(fn, args) {
              return isArray(args)
                ? fn.apply(
                    void 0,
                    (0, tslib__WEBPACK_IMPORTED_MODULE_0__.fX)(
                      [],
                      (0, tslib__WEBPACK_IMPORTED_MODULE_0__.zs)(args),
                    ),
                  )
                : fn(args);
            })(fn, args);

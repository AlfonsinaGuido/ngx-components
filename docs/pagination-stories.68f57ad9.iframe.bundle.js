  ...
  [4623],
  {
    ...
    "./stories/pagination.stories.ts": (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          InteractivePagination: () => InteractivePagination,
        ...
        InteractivePagination = {
          render: (args) => ({
            props: {
              ...args,
              nextPageClicked: () => {
                args.config.currentPage < args.config.totalPages &&
                  (args.config.currentPage += 1);
              },
              previousPageClicked: () => {
                args.config.currentPage > 1 && (args.config.currentPage -= 1);
              },
              pageSelected: (event) => {
      ...
      InteractivePagination.parameters = {
        ...InteractivePagination.parameters,
        docs: {
          ...InteractivePagination.parameters?.docs,
          source: {
            originalSource:
            ...
            ...InteractivePagination.parameters?.docs?.source,
          },
        },
      };
      const __namedExportsOrder = ["InteractivePagination"];
    },
  },
]);

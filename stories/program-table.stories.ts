...
const meta: Meta<ProgramTableComponent> = {
  title: 'Evolution Components/Program Table',
...
export default meta;
type Story = StoryObj<ProgramTableComponent>;
...
const data: ITableItem[] = [
  {
    ...
    cau_descripcion:
      'falta sin Causa Justificada dos dias completos y consecutivos',

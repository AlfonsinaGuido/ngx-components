(self.webpackChunk_aseinfo_evolution_web_components =
  ...
  [4124],
  {
    ...
    "./projects/ngx-evolution-components/menu/menu.component.scss?ngResource": (
      module,
      ...
      ___CSS_LOADER_EXPORT___.push([
        module.id,
        '.menu-button .evo-button .evo-button__content .icon .material-symbols-outlined {\n  font-variation-settings: "FILL" 0, "wght" 400, "GRAD" 0, "opsz" 24;\n}\n\n.user-data-container evo-avatar #avatar-wrapper {\n  background-color: var(--primary-50);\n}\n.user-data-container evo-avatar #avatar-wrapper span {\n  color: var(--primary-700);\n}\n\n.close-button .evo-button.without-border {\n  background-color: transparent;\n  box-shadow: none;\n}\n.close-button .evo-button.without-border .evo-button__content .icon {\n  color: var(--light-gray);\n}\n\n.mat-slide {\n  width: 100%;\n}\n.mat-slide .mdc-form-field {\n  width: 100%;\n  justify-content: space-between;\n  gap: 10px;\n}\n.mat-slide .mdc-form-field label {\n  margin-left: 0;\n  color: var(--medium-gray);\n}\n\n.button-in-menu .evo-button.theme-secondary {\n  justify-content: left;\n  padding: 8px;\n}\n.button-in-menu .evo-button.theme-secondary .evo-button__content {\n  justify-content: left;\n  color: var(--medium-gray);\n}\n.button-in-menu .evo-button.theme-secondary .evo-button__content .label {\n  text-align: left;\n  font-size: 14px;\n}\n\n.see-all-button .evo-button.theme-secondary .evo-button__content {\n  color: var(--medium-gray);\n}',
        "",
      ]),
        (module.exports = ___CSS_LOADER_EXPORT___.toString());
    },
    ...
    "./projects/ngx-evolution-components/menu/menu.component.ts": (
      ...
      "use strict";
      __webpack_require__.d(__webpack_exports__, { Z: () => MenuComponent });
      var tslib_es6 = __webpack_require__("./node_modules/tslib/tslib.es6.mjs");
      ...
      let MenuComponent = class MenuComponent {
        constructor() {
          (this.jobPositionChangeIcon = { icon: "swap_horiz", type: "class" }),
            (this.defaultUserMenuIcons = void 0);
        }
        ngOnInit() {
          if (this.userData) {
            this.icons.buttonIcon ||
              (this.defaultUserMenuIcons = {
                buttonIcon: { icon: "expand_more", type: "class" },
                ...this.icons,
              });
            const lastItem = this.items.length - 1;
            this.items[lastItem].icon ||
              (this.items[lastItem].icon = { icon: "logout", type: "class" });
          }
        }
        ngOnChanges(changes) {
          changes.userData &&
            this.userData?.jobPositions?.length &&
        ...
        static #_ = (this.propDecorators = {
          ...
          seeAllButton: [{ type: core.Input }],
          lengthOfItems: [{ type: core.Input }],
          settingMenu: [{ type: core.Input }],
      ...
      MenuComponent = (0, tslib_es6.Cg)(
        [
          (0, core.Component)({
            ...
            encapsulation: core.ViewEncapsulation.None,
            styles: [
              menu_componentngResource_default(),
              outputngResource_default(),
            ],
          }),
        ],

...
(self.webpackChunk_aseinfo_evolution_web_components =
  ...
  [9801],
  {
    "./node_modules/@storybook/components/dist/formatter-2WMMO6ZP.mjs": (
      ...
      var D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js",
          ),
        memoizerific__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      function _Ui() {
        return (
          (_Ui = (0,
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (t8, e) {
              if ("yaml" === t8.lang) {
                let r = t8.value.trim(),
                  n = r ? yield e(r, { parser: "yaml" }) : "";
        ...
        if ("style" === r.fullName && !e.parentParser && !n.includes("{{"))
          return (function () {
            ...
            D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
              function* (s) {
                return De(
                  yield s(n, { parser: "css", __isHTMLStyleAttribute: !0 }),
                );
              },
            );
            return function (_x8) {
                  ...
                  D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
                    function* (s) {
                      ...
                      return [
                        re,
                        W(r, e),
                        yield s(i, a, { stripTrailingHardline: !0 }),
                        U(r, e),
                      ];
                    },
                  );
      ...
      function _Qu() {
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8 = {}) {
              ...
              if (!r.parser) {
                ...
                if (
                  ((r.parser = Rr(r, { physicalFile: r.filepath })), !r.parser)
                )
                  throw new ve2(
          ...
          _Qu.apply(this, arguments)
        );
      }
      var re2 = function Qu(_x23) {
        ...
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8, r, n, o) {
              ...
              function f2(l, F2) {
                return (function _o2(_x31, _x32, _x33, _x34) {
      ...
      function _je() {
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8) {
              ({ ast: e } = yield Ht2(e, t8));
              let r = new Map(),
                n = new Bn2(e),
                u = new Map();
              yield (function Ln2(_x26, _x27, _x28, _x29, _x30) {
            ...
            function* (e, t8) {
              ...
              (t8[Symbol.for("comments")] = r),
                ...
                (function Nn2(e, t8) {
                  let { comments: r } = e;
                  if (
                    (delete e.comments, !Mt2(r) || !t8.printer.canAttachComment)
                  )
                    return;
                  let n = [],
                    {
              ...
              return { ast: (e = n ? yield n(e, t8) : e), comments: r };
            },
          )),
          _Ht.apply(this, arguments)
        );
      }
      var bo2 = ({ parser: e }) =>
        ...
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8, r = 0) {
              ...
              let { ast: n, text: o } = yield De2(e, t8);
      ...
      function _vo() {
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8) {
              let { ast: r, text: n } = yield De2(e, t8),
      ...
      function _Xn() {
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8, r) {
              let { text: n, options: o } = Jn2(e, yield re2(t8)),
                u = yield De2(n, o);
              return (
                r &&
                  (r.preprocessForPrint && (u.ast = yield Ht2(u.ast, o)),
                  r.massage && (u.ast = fn2(u.ast, o))),
                u
              );
            },
          )),
          _Xn.apply(this, arguments)
        );
      }
      function _Zn() {
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8) {
              return (t8 = yield re2(t8)), fe2(yield je2(e, t8), t8);
            },
          )),
          _Zn.apply(this, arguments)
        );
      }
      function _Qn() {
        return (
      ...
      function _eu() {
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8) {
              t8 = yield re2(t8);
              let { ast: r } = yield De2(e, t8);
              return je2(r, t8);
            },
          )),
          _eu.apply(this, arguments)
        );
      }
      function _tu() {
        return (
      ...
      function _cu() {
        return (
          ...
          D_yesic_Escritorio_ASEINFO_Proyectos_evolutionWebComponents_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__.A)(
            function* (e, t8) {
              let { formatted: r } = yield au(e, { ...t8, cursorOffset: -1 });
              return r;
            },
          )),
          _cu.apply(this, arguments)
        );
      }
      ...
      function _ei() {
        return (
          ...
          _ei.apply(this, arguments)
        );
      }
      var ti2 = ae(et2, 0),
        ri2 = {
          parse: ae(function Xn2(_x47, _x48, _x49) {
            return _Xn.apply(this, arguments);
          }),
          formatAST: ae(function Zn2(_x50, _x51) {
            return _Zn.apply(this, arguments);
          }),
          formatDoc: ae(function Qn2(_x52, _x53) {
            return _Qn.apply(this, arguments);
          }),
          printToDoc: ae(function eu(_x54, _x55) {
            return _eu.apply(this, arguments);
          }),
          printDocToString: ae(function tu(_x56, _x57) {
